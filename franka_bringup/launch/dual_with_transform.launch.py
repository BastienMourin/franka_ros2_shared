...
def generate_nodes(context):
    ...
    #
    # NOTE: stock franka_description ignores the 'connected_to' argument, so
    # this only works after patching robots/fr3/fr3.urdf.xacro. At the end of
    # that file, in the <xacro:franka_robot arm_id="fr3" ...> block, change
    #     connected_to="base"
    # to
